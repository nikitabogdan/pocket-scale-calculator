...
import methods.getListOfTonicIndexesForBothOctaves
import methods.transpose

enum class Scales(
    val scaleName: String,
    val tonicKeyIndexes: List<Int>,
    ...
    MINOR_NATURAL_MAJOR(
        ...
        ButtonIndexes.BT07.getListOfTonicIndexesForBothOctaves(),
    ...
    MINOR_NATURAL_MINOR(
        ...
        ButtonIndexes.BT05.getListOfTonicIndexesForBothOctaves(),
        ButtonIndexes.BT04.getListOfOutOfScaleIndexesForBothOctaves(),
    ...
    MINOR_BLUES(
        ScaleNames.BLUES,
        ButtonIndexes.BT08.getListOfTonicIndexesForBothOctaves(),
        intArrayOf(
            ButtonIndexes.BT01,
            ButtonIndexes.BT06
        ).getListOfOutOfScaleIndexesForBothOctaves(),
    ...
    MINOR_LYDIAN(
        ScaleNames.LYDIAN,
        ButtonIndexes.BT02.getListOfTonicIndexesForBothOctaves(),
        ButtonIndexes.BT04.getListOfOutOfScaleIndexesForBothOctaves(),
    ...
    MINOR_MIXOLYDIAN(
        ...
        ButtonIndexes.BT03.getListOfTonicIndexesForBothOctaves(),
        ButtonIndexes.BT04.getListOfOutOfScaleIndexesForBothOctaves(),
    ...
    MINOR_LOCRIAN(
        ScaleNames.LOCRIAN,
        ButtonIndexes.BT06.getListOfTonicIndexesForBothOctaves(),
        ButtonIndexes.BT04.getListOfOutOfScaleIndexesForBothOctaves(),
    ...
    MINOR_PHRYGIAN(
        ScaleNames.PHRYGIAN,
        ButtonIndexes.BT01.getListOfTonicIndexesForBothOctaves(),
        ButtonIndexes.BT04.getListOfOutOfScaleIndexesForBothOctaves(),
    ...
    MAJOR_LOCRIAN(
        ScaleNames.LOCRIAN,
        ButtonIndexes.BT04.getListOfTonicIndexesForBothOctaves(),
        ButtonIndexes.BT03.getListOfOutOfScaleIndexesForBothOctaves(),
